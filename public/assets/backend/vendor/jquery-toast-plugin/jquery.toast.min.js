  ...
  var n = {
      ...
      if (
        ...
        this.options.heading &&
          (o +=
            '<h2 class="jq-toast-heading">' +
            this.options.heading +
            "</h2>"), (o += this.options.text);
      this._toastEl.html(o), this.options.bgColor !== !1 &&
        this._toastEl.css("background-color", this.options.bgColor), this
        .options.textColor !== !1 &&
        this._toastEl.css("color", this.options.textColor), this.options
        .textAlign &&
        this._toastEl.css("text-align", this.options.textAlign), this.options
        .icon !== !1 &&
        (
        ...
        ? "bottom-center" === this.options.position
          ...
          : "top-center" === this.options.position
            ...
            : "mid-center" === this.options.position
              ? this._container.css({
                  left:
                    t(o).outerWidth() / 2 - this._container.outerWidth() / 2,
                  top:
                    t(o).outerHeight() / 2 - this._container.outerHeight() / 2
                })
    ...
    processLoader: function() {
      ...
      var t = this._toastEl.find(".jq-toast-loader"),
        ...
        s = t.attr("style") || "";
      (s = s.substring(0, s.indexOf("-webkit-transition"))), (s +=
