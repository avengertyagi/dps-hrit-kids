                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="header-title">Add Media</h4>
                        </div>
                        <form class="form-horizontal" id="mediaForm" method="POST"
                            action="{{ route('media.store') }}" class="form-horizontal"
                                ...
                                <div class="mb-2 row">
                                    ...
                                    <div class="col-md-6">
                                        <label class="col-form-label" for="url">URL</label><code
                                            class="text-danger fs-4">*</code>
                                        <input type="text" class="form-control" id="url" name="content" placeholder="URL">
                                    </div>
                                </div>
                                <div class="mb-2 row">
