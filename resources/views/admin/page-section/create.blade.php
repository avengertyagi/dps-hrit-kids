                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="header-title">Add Page Section</h4>
                        </div>
                        <form class="form-horizontal" id="pageForm" method="POST" action="{{ route('page-sections.store') }}"
                                ...
                                <div class="mb-2 row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="section_title" name="section_title"
                                            value="{{ old('section_title') }}" placeholder="Section Title" maxlength="100">
                                    </div>
                                    <div class="col-md-6">
                                        <label class="col-form-label" for="section_name">Section Name</label><code
                                            class="text-danger fs-4">*</code>
                                        <input type="text" class="form-control" id="section_name" name="section_name"
                                            value="{{ old('section_name') }}" placeholder="Section Name" maxlength="100">
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <a href="{{ asset('assets/backend/images/picture.png') }}"
                                            data-fancybox="gallery" id="image_link">
                                            <img id="image-preview"
                                                src="{{ asset('assets/backend/images/picture.png') }}" alt="thumbnail"
                    ...
                    processResults: function(data, params) {
                        ...
                        return {
                            results: data.data.map(function(item) {
                                return {
                                    id: item.id,
                                    text: item.section_title.charAt(0).toUpperCase() + item.section_title.slice(
                                        1)
                                };
                            }),
                            pagination: {
