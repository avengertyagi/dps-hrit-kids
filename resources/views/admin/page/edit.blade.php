                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <form class="form-horizontal" id="pageForm" method="POST"
                            action="{{ route('pages.update', $module_data->id) }}') }}" class="form-horizontal"
...
@push('js')
    <script>
        let selectedParent = @json($module_data->parent ?? null);
                    ...
                    validator: (value) => () =>
                        new Promise((resolve) => {
                            fetch("{{ route('pages.check-unique') }}", {
                                    ...
                                    body: JSON.stringify({
                                        title: value,
                                        page_id: @json($module_data->id ?? null),
                                    })
                                })
                                .then(response => {
                                    if (!response.ok) {
