            ...
            <div class="row p-2">
                <div class="col-12">
                    <div class="card">
                        ...
                        <form class="form-horizontal" id="photoForm" method="POST" action="{{ route('photos.store') }}"  class="form-horizontal" autocomplete="off" novalidate="novalidate" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <div class="mb-2 row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <img id="image-preview" src="{{ asset('assets/backend/images/picture.png') }}"
        ...
        validation
            .addField('#title', [{
                ...
                },
                {
                    validator: (value) => () =>
                        new Promise((resolve) => {
                            fetch("{{ route('photos.checkUnique') }}", {
                                    method: 'POST',
                                    headers: {
