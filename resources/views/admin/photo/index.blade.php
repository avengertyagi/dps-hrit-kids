                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                <h4 class="header-title m-0">Photo List</h4>
                                <a href="{{ route('photos.create') }}" class="btn btn-sm btn-primary text-white">
...
@push('js')
    <script>
        ...
        $(function() {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                $.ajax({
                                    ...
                                    url: "{{ route('photos.status.change') }}",
                                    type: "POST",
                                    dataType: 'json',
                                    data: {
                                        id: roleId,
            ...
            $('#photo-table').on('error.dt', function(e, settings, techNote, message) {
