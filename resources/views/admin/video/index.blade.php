                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                <h4 class="header-title m-0">Video List</h4>
                                <a href="{{ route('videos.create') }}" class="btn btn-sm btn-primary text-white">
...
@push('js')
    <script>
        ...
        $(function() {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                $.ajax({
                                    ...
                                    url: "{{ route('videos.status.change') }}",
                                    type: "POST",
                                    dataType: 'json',
                                    data: {
                                        id: roleId,
            ...
            $('#video-table').on('error.dt', function(e, settings, techNote, message) {
