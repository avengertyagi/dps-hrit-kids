                ...
                @if (!empty($module_data['photos']))
                    <div class="row">
                        @foreach ($module_data['photos'] as $photo)
                            <div class="col-md-3">
                                <a href="{{ route('photos.details', $photo->slug ?? '') }}">
                                    <div class="bd-gallery mb-25 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                                        <div class="bd-gallery-thumb-wrapper">
                                            <div class="bd-gallery-thumb">
                                                <img src="{{ asset($photo->thumbnail_image ?? 'assets/frontend/img/gallery/d2.png') }}"
                                                     alt="img not found!">
                                            </div>
                                            <div class="bd-gallery-icon">
                                                <a href="{{ asset($photo->thumbnail_image ?? 'assets/frontend/img/gallery/d2.png') }}"
